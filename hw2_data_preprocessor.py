...
# Date:     2019/03/12
# Program:  hw2_data_preprocessor.py
# SDK(s):   None


'''This file is designed to preprocess the power measurement data. It converts 
the human-readable data/time field into a unix timestamp. 
